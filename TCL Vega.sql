...
-- Se crea una transacción eliminando de la tabla Cliente aquellos con id mayor a 5
START TRANSACTION;
DELETE FROM Cliente
WHERE id_cliente > 5;

-- Se pueden ejecutar las sentencias ROLLBACK y COMMIT
-- ROLLBACK;
-- COMMIT;

-- Se verifica como queda la tabla Cliente
SELECT * FROM Cliente;
...
-- Se crea una transacción insertando registros en la tabla Menu con 2 savepoints
START TRANSACTION;
INSERT INTO Menu (id_plato,plato,porciones,precio) VALUES (356,'Empanada',34,80);
INSERT INTO Menu (id_plato,plato,porciones,precio) VALUES (357,'Sushi',10,400);
INSERT INTO Menu (id_plato,plato,porciones,precio) VALUES (358,'Ravioles',5,550);
INSERT INTO Menu (id_plato,plato,porciones,precio) VALUES (359,'Hamburguesa',21,600);
SAVEPOINT insert_1;
INSERT INTO Menu (id_plato,plato,porciones,precio) VALUES (360,'Asado con guarnición',7,900);
INSERT INTO Menu (id_plato,plato,porciones,precio) VALUES (361,'Pizza',9,250);
INSERT INTO Menu (id_plato,plato,porciones,precio) VALUES (362,'Helado',12,120);
INSERT INTO Menu (id_plato,plato,porciones,precio) VALUES (363,'Flan',6,200);
SAVEPOINT insert_2;

-- Se elimina el savepoint de los 4 primeros registros
RELEASE SAVEPOINT insert_1;

-- Se verifica que el savepoint de los 4 primeros registros no exista
-- ROLLBACK TO insert_1;

-- Se verifica como queda la tabla Menu
SELECT * FROM Menu;
